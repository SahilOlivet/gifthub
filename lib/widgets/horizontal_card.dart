      ...
      children: <Widget>[
        ...
        Container(
          ...
          child: ListView.builder(
            ...
            itemCount: imagesAndTitle.length,
            itemBuilder: (BuildContext context, int index) {
              //NewDataModel newCard =newDataModelObject[index];
              ImagesAndTitleModel newCard =imagesAndTitle[index];
              return GestureDetector(
                onTap: () => Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) =>   DetailsPage(
                        universalDataModel: imagesAndTitle[index]),
                  ),
                ),
                child: Container(
                        ...
                        child: Container(
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: <Widget>[
                                // Text(
                                //   '${imagesAndTitle.length} activities',
                                //   style: TextStyle(
                                //     fontSize: 22.0,
                                //     fontWeight: FontWeight.w600,
                                //     letterSpacing: 1.2,
